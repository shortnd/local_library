...
class Book(models.Model):
    ...
    isbn = models.CharField(
        'ISBN', max_length=13, help_text='13 Charater <a href="htpps://isbn-international.org/content/what-isbn">ISBN number</a>')
...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(
        primary_key=True,
        default=uuid.uuid4,
        help_text='Unique ID for this particular book across library'
    )
...
class Author(models.Model):
    """ Model representation of a books author """
